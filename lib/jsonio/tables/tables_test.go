...
func TestSaveDumpTables(t *testing.T) {
	...
	assert.Equal[any](t, aT10["a"], nil)
	assert.Equal[any](t, aT10["b"], json.Number("123"))
	assert.Equal[any](t, aT10["c"], json.Number("-123.45"))
	assert.Equal[any](t, aT10["d"], "abc")
	assert.Equal[any](t, aT10["e"], false)
	assert.Equal[any](t, aT10["f"], true)

	aT11 := aT1[1]
	assert.Equal(t, len(aT11), 6)
	assert.Equal[any](t, aT11["a"], nil)
	assert.Equal[any](t, aT11["b"], json.Number("123"))
	assert.Equal[any](t, aT11["c"], json.Number("-123.45"))
	assert.Equal[any](t, aT11["d"], "abc")
	assert.Equal[any](t, aT11["e"], false)
	assert.Equal[any](t, aT11["f"], true)
	...
	assert.Equal[any](t, aT20["x"], nil)
	assert.Equal[any](t, aT20["y"], json.Number("123"))
	assert.Equal[any](t, aT20["z"], json.Number("-123.45"))

	aT21 := aT2[1]
	assert.Equal(t, len(aT21), 3)
	assert.Equal[any](t, aT21["x"], nil)
	assert.Equal[any](t, aT21["y"], json.Number("123"))
	assert.Equal[any](t, aT20["z"], json.Number("-123.45"))
}
